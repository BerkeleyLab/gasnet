...
void gasnetc_free_bounce_buffer(void *buf, int didx);
#else
...
void _gasnetc_free_bounce_buffer(void *buf);
...
#define gasnetc_free_bounce_buffer(buf,didx) _gasnetc_free_bounce_buffer(buf)
#endif
