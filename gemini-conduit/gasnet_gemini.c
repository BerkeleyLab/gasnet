...
{
  gasnetc_post_descriptor_t *gpd = gasnetc_alloc_post_descriptor(GNI_DEFAULT_DOMAIN);
  gni_post_descriptor_t *pd = &gpd->pd;
  unsigned int slot;
...
{
#if GNI_MULTI_DOMAIN
  peer_struct_t * const peer_data = gasnetc_cdom_data[GNI_DEFAULT_DOMAIN].peer_data;
#endif
