 ...
 *     For use ONLY by gasnet_sysv.[ch]
 *
 ...
 */
  ...
  #endif
  #ifndef gasnetc_token_is_sysv
    extern int gasnetc_token_is_sysv(gasnet_token_t token);
  #endif
#else
  #define gasnetc_token_is_sysv(tok) ((uintptr_t)(tok)&1)
 ...
 * gasneti_sysv_in_supernode(dest) or gasnetc_token_is_sysv(token) is nonzero */ 
