...
// Otherwise they remain undefined
  ...
  #define GASNETI_CONFIG_HAVE_GCC_ASM           GASNETI_HAVE_CC_GCC_ASM
  #define GASNETI_CONFIG_HAVE_XLC_ASM           GASNETI_HAVE_CC_XLC_ASM
  #define GASNETI_CONFIG_HAVE_SYNC_ATOMICS_32   GASNETI_HAVE_CC_SYNC_ATOMICS_32
  #define GASNETI_CONFIG_HAVE_SYNC_ATOMICS_64   GASNETI_HAVE_CC_SYNC_ATOMICS_64
#elif !GASNETI_COMPILER_IS_UNKNOWN
  #define GASNETI_CONFIG_HAVE_GCC_ASM           GASNETI_COMPILER_HAS(GCC_ASM)
  #define GASNETI_CONFIG_HAVE_XLC_ASM           GASNETI_COMPILER_HAS(XLC_ASM)
  #define GASNETI_CONFIG_HAVE_SYNC_ATOMICS_32   GASNETI_COMPILER_HAS(SYNC_ATOMICS_32)
  #define GASNETI_CONFIG_HAVE_SYNC_ATOMICS_64   GASNETI_COMPILER_HAS(SYNC_ATOMICS_64)
#endif
...
/* Identify special cases lacking native support */
  ...
  #define GASNETI_USE_OS_ATOMICOPS 1
    ...
    (PLATFORM_COMPILER_XLC && !GASNETI_CONFIG_HAVE_XLC_ASM && GASNETI_CONFIG_HAVE_SYNC_ATOMICS_32) || \
...
// identifier (one defined above, or new ones added).
  ...
  #if GASNETI_CONFIG_HAVE_SYNC_ATOMICS_32
    #define GASNETI_ATOMIC32_IMPL GASNETI_ATOMIC_IMPL_SYNC
    #if PLATFORM_ARCH_64 && GASNETI_CONFIG_HAVE_SYNC_ATOMICS_64
  ...
  #if GASNETI_CONFIG_HAVE_GCC_ASM || (PLATFORM_COMPILER_XLC && GASNETI_CONFIG_HAVE_XLC_ASM)
    #define GASNETI_ATOMIC32_IMPL GASNETI_ATOMIC_IMPL_NATIVE
    #if PLATFORM_ARCH_64
      #define GASNETI_ATOMIC64_IMPL GASNETI_ATOMIC_IMPL_NATIVE
...
#undef GASNETI_CONFIG_HAVE_GCC_ASM
#undef GASNETI_CONFIG_HAVE_XLC_ASM
