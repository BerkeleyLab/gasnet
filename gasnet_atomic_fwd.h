...
// identifier (one defined above, or new ones added).
  ...
  #elif (PLATFORM_COMPILER_PATHSCALE && PLATFORM_COMPILER_VERSION_LT(2,3,0) && PLATFORM_ARCH_64)
    // Native via inline and NON-inline ASM (w/ NON-inline only for portion of 64-bit)
