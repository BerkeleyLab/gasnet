...
/*---------------------------------------------------------------------------------*/
  ...
  #define GASNETE_VIS_AMPIPELINE_HANDLERS()                               \
    gasneti_handler_tableentry_with_bits(gasnete_putv_AMPipeline_reqh,2,3,GEX_FLAG_AM_REPLY|GEX_FLAG_AM_MEDIUM),   \
    gasneti_handler_tableentry_with_bits(gasnete_putvis_AMPipeline_reph,1,2,GEX_FLAG_AM_REPLY|GEX_FLAG_AM_SHORT), \
    gasneti_handler_tableentry_with_bits(gasnete_getv_AMPipeline_reqh,2,3,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM),   \
    gasneti_handler_tableentry_with_bits(gasnete_getv_AMPipeline_reph,2,3,GEX_FLAG_AM_REPLY|GEX_FLAG_AM_MEDIUM),   \
    gasneti_handler_tableentry_with_bits(gasnete_puti_AMPipeline_reqh,5,6,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM),   \
    gasneti_handler_tableentry_with_bits(gasnete_geti_AMPipeline_reqh,5,6,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM),   \
    gasneti_handler_tableentry_with_bits(gasnete_geti_AMPipeline_reph,2,3,GEX_FLAG_AM_REPLY|GEX_FLAG_AM_MEDIUM),   \
    gasneti_handler_tableentry_with_bits(gasnete_puts_AMPipeline_reqh,5,7,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM),   \
    gasneti_handler_tableentry_with_bits(gasnete_gets_AMPipeline_reqh,6,8,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM),   \
    gasneti_handler_tableentry_with_bits(gasnete_gets_AMPipeline_reph,4,5,GEX_FLAG_AM_REPLY|GEX_FLAG_AM_MEDIUM),
#else
  #define GASNETE_VIS_AMPIPELINE_HANDLERS()
#endif
