/*   $Source: bitbucket.org:berkeleylab/gasnet.git/extended-ref/gasnet_extended_refcoll.h $
...
MEDIUM_HANDLER_NOBITS_DECL(gasnete_coll_p2p_med_counting_reqh,5);
  ...
  #define GASNETE_COLL_P2P_HANDLERS() \
      gasneti_handler_tableentry_with_bits(gasnete_coll_p2p_memcpy_reqh,4,5,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM), \
      gasneti_handler_tableentry_no_bits(gasnete_coll_p2p_short_reqh,5,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_SHORT),    \
      gasneti_handler_tableentry_no_bits(gasnete_coll_p2p_med_reqh,6,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM),      \
      gasneti_handler_tableentry_no_bits(gasnete_coll_p2p_long_reqh,5,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_LONG),     \
      gasneti_handler_tableentry_no_bits(gasnete_coll_p2p_med_tree_reqh,2,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM), \
      gasneti_handler_tableentry_no_bits(gasnete_coll_p2p_advance_reqh,3,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_SHORT), \
      gasneti_handler_tableentry_no_bits(gasnete_coll_p2p_put_and_advance_reqh,3,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_LONG), \
      gasneti_handler_tableentry_no_bits(gasnete_coll_p2p_med_counting_reqh,5,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_MEDIUM), \
      gasneti_handler_tableentry_no_bits(gasnete_coll_p2p_seg_put_reqh,3,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_LONG),
...
#define GASNETE_COLL_SCRATCH_HANDLERS() gasneti_handler_tableentry_no_bits(gasnete_coll_scratch_update_reqh,2,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_SHORT),
#endif

#ifndef GASNETE_COLL_TEAM_OVERRIDE
SHORT_HANDLER_NOBITS_DECL(gasnete_coll_teamid_reqh, 1);
#define GASNETE_COLL_TEAM_HANDLERS() gasneti_handler_tableentry_no_bits(gasnete_coll_teamid_reqh,1,GEX_FLAG_AM_REQUEST|GEX_FLAG_AM_SHORT),
#endif
