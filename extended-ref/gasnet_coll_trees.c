...
typedef enum {GASNET_COLL_BROADCAST_OP=0, 
              ...
              GASNET_COLL_EXCHANGE_OP} gasnet_coll_optype_t;

extern int gasnet_coll_get_num_tree_types(gasnet_team_handle_t team, gasnet_coll_optype_t optype);
...
gasnete_coll_tree_type_t gasnete_coll_make_tree_type(int tree_class, gasnet_node_t fanout) {
  gasnete_coll_tree_type_t ret;
