...
#define _gasneti_harg(a,b,c) ,gasnet_handlerarg_t
#define _gasneti_harg_pass(Nm1,N,Np1) ,_pArgs[Nm1]

#define _gasneti_Short_handlerfn_typedefN(Nm1,N,Np1) \
  typedef void (*gasneti_Short_handlerfn_type_##N)(gasnet_token_t GASNETI_META_DES##N(GASNETI_META_EMPTY,_gasneti_harg));
...
#define GASNETI_RUN_HANDLER_SHORT(isReq, hid, phandlerfn, token, pArgs, numargs) do { \
  gasneti_handler_fn_t const _phandlerfn = (gasneti_handler_fn_t)(phandlerfn);  \
  gasnet_token_t const _token = (token);                                        \
  gasnet_handlerarg_t const * const _pArgs = (gasnet_handlerarg_t *)(pArgs);    \
...
#define _gasneti_MedLong_handlerfn_typedefN(Nm1,N,Np1) \
  typedef void (*gasneti_MedLong_handlerfn_type_##N)(gasnet_token_t, void *, size_t GASNETI_META_DES##N(GASNETI_META_EMPTY,_gasneti_harg));
