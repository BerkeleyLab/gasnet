...
extern void gasneti_check_config_preinit(void) {
  ...
  gasneti_assert_always(SIZEOF_GASNETEX_REGISTER_VALUE_T == sizeof(gasnetex_register_value_t));
  gasneti_assert_always(SIZEOF_GASNETEX_REGISTER_VALUE_T >= sizeof(int));
  gasneti_assert_always(SIZEOF_GASNETEX_REGISTER_VALUE_T >= sizeof(void *));
