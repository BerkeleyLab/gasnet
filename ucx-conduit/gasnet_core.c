/*   $Source: github.com:BerkeleyLab/gasnet.git/ucx-conduit/gasnet_core.c $
...
#error gasnetc_AM_PrepareRequestMedium unimplemented
...
#error gasnetc_AM_PrepareReplyMedium unimplemented
