...
We will also assume that the scratch space can be reset on a barrier. The main implementation problems that could arise are nonblocking collective calls initiated before a barrier and a sync taking place after that given barrier. Thus to simplify the initial implementation we will assume that \textit{there will be no barriers between a nonblocking collective initiation and a nonblocking collective sync}. This restriction could be lifted later. 
