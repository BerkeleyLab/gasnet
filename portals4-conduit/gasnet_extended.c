...
gasnet_handle_t
gasnete_get_nb_bulk(void *dest, gasnet_node_t node, void *src, size_t nbytes GASNETI_THREAD_FARG)
{
...
gasnet_handle_t
gasnete_put_nb(gasnet_node_t node, void *dest, void *src, size_t nbytes GASNETI_THREAD_FARG)
{
...
gasnet_handle_t
gasnete_put_nb_bulk(gasnet_node_t node, void *dest, void *src, size_t nbytes GASNETI_THREAD_FARG)
{
    GASNETI_CHECKPSHM_PUT(UNALIGNED,H,node,dest,src,nbytes);
    {
        gasnete_eop_t *op = _gasnete_eop_new(GASNETE_MYTHREAD);
...
void
gasnete_get_nbi_bulk(void *dest, gasnet_node_t node, void *src, size_t nbytes GASNETI_THREAD_FARG)
{
...
void
gasnete_put_nbi(gasnet_node_t node, void *dest, void *src, size_t nbytes GASNETI_THREAD_FARG)
{
...
void
gasnete_put_nbi_bulk(gasnet_node_t node, void *dest, void *src, size_t nbytes GASNETI_THREAD_FARG)
{
    GASNETI_CHECKPSHM_PUT(ALIGNED,V,node,dest,src,nbytes);
    {
        gasnete_threaddata_t * const mythread = GASNETE_MYTHREAD;
