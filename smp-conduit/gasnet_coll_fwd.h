...
#define GASNETE_SMP_COLL_OVERRIDE 1

#if GASNETE_SMP_COLL_OVERRIDE
#define GASNETE_COLL_THREADDATA_EXTRA void* smp_coll_team;

/*override broadcastM function*/
#define gasnete_coll_broadcastM gasnete_smp_coll_broadcastM
#define gasnete_coll_broadcastM_nb gasnete_smp_coll_broadcastM_nb
#endif
