...
#define GASNETE_AUXSEG_FNS() gasnete_coll_auxseg_alloc, gasnete_coll_auxseg2_alloc,
...
#define GASNETE_COLL_CONDUIT_BROADCASTM_OPS GASNETE_COLL_BROADCAST_SMP
#endif
