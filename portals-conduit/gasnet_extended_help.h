...
/* cannot exceed 256, but Portals conduit will use most significant bit to store the
 * type of a handle.  This way, references to both eops and iops can be stored in a
 * compact 24 bit representation */
