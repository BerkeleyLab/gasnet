...
#define GASNETC_PGCTRL_THROTTLE 64
  ...
  #define GASNETC_EXITINPROGRESS()       (gasneti_atomicX_read(&gasnetc_remoteexitflag, 0) != 1)
  #define GASNETC_REMOTEEXITINPROGRESS() (gasneti_atomicX_read(&gasnetc_remoteexitrecvd, 0) != 0)
#else 
