...
#define gex_AM_MaxRequestMedium(tm,rank,lc_opt,flags,nargs) ((size_t)GASNETC_MAX_MEDIUM_(nargs))
#define gex_AM_MaxReplyMedium(tm,rank,lc_opt,flags,nargs)   ((size_t)GASNETC_MAX_MEDIUM_(nargs))
