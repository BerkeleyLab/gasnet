/*   $Source: github.com:BerkeleyLab/gasnet.git/ibv-conduit/gasnet_core_sndrcv.c $
...
void gasnetc_do_put_inline(
  ...
  gasnetc_post_write(sreq, sr_desc, /*inline=*/1 GASNETI_THREAD_PASS);
...
void gasnetc_do_put_bounce(
  ...
  do {
    ...
    gasnetc_post_write(sreq, sr_desc, /*inline=*/0 GASNETI_THREAD_PASS);
...
void gasnetc_fh_put_bounce(gasnetc_sreq_t *orig_sreq GASNETI_THREAD_FARG) {
  ...
  gasnetc_post_write(orig_sreq, sr_desc, /*inline=*/0 GASNETI_THREAD_PASS);
}
